...
font_small = pygame.font.SysFont("fixedsys", 20)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                elif selected_player and 350 <= x <= 450 and 500 <= y <= 550:
                    game_started = True  # Start the game when the button is clicked
        ...
        if not in_game:
            ...
            if game_started:
                draw_text("Game Started!", font_large, TEXT_COLOR, (100, 200))
                # You can start the game logic here; for now, it's just a placeholder screen
                # This part can later be expanded with the actual gameplay.
